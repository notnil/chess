...
var (
	...
	// validMoves = []*Move{
	// 	// pawn moves
	// 	&Move{s1: A4, s2: B3, pos: unsafeFEN("2r3k1/1q1nbppp/r3p3/3pP3/pPpP4/P1Q2N2/2RN1PPP/2R4K b - b3 0 23")},
	// 	&Move{s1: A2, s2: A1, promo: Queen, pos: unsafeFEN("8/8/8/8/8/8/p7/8 b - - 0 1")},
	// }

	// invalidMoves = []*Move{
	// 	// out of turn moves
	// 	&Move{s1: E7, s2: E5, pos: unsafeFEN("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1")},
	// 	&Move{s1: E2, s2: E4, pos: unsafeFEN("rnbqkbnr/1ppppppp/p7/8/8/8/PPPPPPPP/RNBQKBNR b KQkq - 0 1")},
	// 	// pawn moves
	// 	&Move{s1: E2, s2: D3, pos: unsafeFEN("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1")},
	// 	&Move{s1: E2, s2: F3, pos: unsafeFEN("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1")},
	// 	&Move{s1: E2, s2: E5, pos: unsafeFEN("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1")},
	// 	&Move{s1: A2, s2: A1, pos: unsafeFEN("8/8/8/8/8/8/p7/8 b - - 0 1")},
	// 	&Move{s1: E6, s2: E5, pos: unsafeFEN(`2b1r3/2k2p1B/p2np3/4B3/8/5N2/PP1K1PPP/3R4 b - - 2 1`)},
	// 	&Move{s1: H7, s2: H5, pos: unsafeFEN(`2bqkbnr/rpppp2p/2n2p2/p5pB/5P2/4P3/PPPP2PP/RNBQK1NR b KQk - 4 6`)},
	// }
)
